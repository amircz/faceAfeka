...
<h1><font color= "blue">User Registeration</font></h1>

<h3><font color= "blue">Please fill all the fields</font></h3>
...
<FORM action="authUser.php" method="POST" id="form">
	<table width = "300px">
		...
		<tr><td><font color = "blue">User Image:</font></td><td><input type="file" name= "img" id = "img" ><font color = "blue">(optional)</font></td></tr>
		<tr><td><input type="image" src = "images/registerBlue.png" value="submit" id="submit" width = "150px" height = "50px"></td></tr>
	</table>
</FORM>
